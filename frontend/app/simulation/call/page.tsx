...
import { api, type LiveCoaching, type SimulationTurn, type TranscriptEntry } from "@/lib/apiClient";
...
function CtrlBtn({
  ...
  const toneStyle = tone === "violet"
    ...
    : tone === "amber"
      ...
      : tone === "teal"
        ? { background: "rgba(45,212,191,0.14)", color: "#5EEAD4", borderColor: "rgba(45,212,191,0.35)" }
        : {};
